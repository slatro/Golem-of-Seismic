...
If you want the fastest way into the project, open these first:

1. [GOLEM_OF_SEISMIC_MASTER_GDD.md](./GOLEM_OF_SEISMIC_MASTER_GDD.md)
2. [GOLEM_OF_SEISMIC_ARCHITECTURE_PLAN.md](./GOLEM_OF_SEISMIC_ARCHITECTURE_PLAN.md)
3. [GOLEM_OF_SEISMIC_ROOM_SCRIPTS.md](./GOLEM_OF_SEISMIC_ROOM_SCRIPTS.md)
4. [SEISMIC_GOLEM_LORE.md](./SEISMIC_GOLEM_LORE.md)
...
Use this file as the main entry point, and [PROJECT_INDEX.md](./PROJECT_INDEX.md) as the full categorized document map.
...
- the stone golem character stays visually consistent
- the pink chest crystal remains the main accent and symbolic core
- the game is not combat-first
- the world should feel like sacred infrastructure, not generic fantasy
- each chamber must teach meaning through architecture, not exposition dumps
